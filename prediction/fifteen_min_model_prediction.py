...
def predict_next_day_with_fifteen_min_model():
    model = keras.models.load_model("model/btc_only/transformer_model_15min.keras")
    ...
    SEQ_LENGTH = 1  # 15 minutes of 15-minute intervals
