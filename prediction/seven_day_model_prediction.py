...
def predict_next_day_with_seven_day_model():
    # Load the 7-day model and the same scaler
    model = keras.models.load_model("model/btc_only/transformer_model_7days.keras")
    ...
    limit = 96*7  # 7 days of 15-min intervals
    ...
    for step in range(96):  # Predict next 1 day (96 intervals)
