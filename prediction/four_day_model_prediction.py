...
def predict_next_day_with_four_day_model():
    # Load the 4-day model and the same scaler
    model = keras.models.load_model("model/btc_only/transformer_model_4days.keras")
    ...
    limit = 96*4  # 4 days of 15-min intervals
