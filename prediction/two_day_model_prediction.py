...
def predict_next_day_with_two_day_model():
    # Load the two-day model and the same scaler
    model = keras.models.load_model("model/btc_only/transformer_model_2days.keras")
    ...
    limit = 192  # 2 days of 15-min intervals
