...
def predict_next_day_with_five_day_model():
    # Load the 5-day model and the same scaler
    model = keras.models.load_model("model/btc_only/transformer_model_5days.keras")
    ...
    limit = 96*5  # 5 days of 15-min intervals
