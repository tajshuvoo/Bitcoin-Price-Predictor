...
def predict_next_day_with_three_day_model():
    # Load the 3-day model and the same scaler
    model = keras.models.load_model("model/btc_only/transformer_model_3days.keras")
    ...
    limit = 288  # 3 days of 15-min intervals
