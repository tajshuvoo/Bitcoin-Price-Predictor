...
def predict_next_day_with_six_day_model():
    # Load the 6-day model and the same scaler
    model = keras.models.load_model("model/btc_only/transformer_model_6days.keras")
    ...
    limit = 96*6  # 6 days of 15-min intervals
