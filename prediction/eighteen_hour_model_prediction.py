...
def predict_next_day_with_eighteen_hour_model():
    model = keras.models.load_model("model/btc_only/transformer_model_18hour.keras")
    ...
    SEQ_LENGTH = 72  # 18 hours of 15-minute intervals
